...
public class ShopController : MonoBehaviour
{
    ...
    private readonly Dictionary<int, string[]> ballSkinDictionary = new Dictionary<int, string[]> { // TODO SKIN FRAGMENT COLORS
        ...
        {8, new string[]{ "100", "#F497AA"} },
        {9, new string[]{ "100", "#F497AA"} },
        {10, new string[]{ "100", "#F497AA"} },
        {27, new string[]{ "250", "Flags/albania:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {28, new string[]{ "250", "Flags/america:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {29, new string[]{ "250", "Flags/argentina:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {30, new string[]{ "250", "Flags/armenia:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {31, new string[]{ "250", "Flags/australia:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {32, new string[]{ "250", "Flags/austria:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {33, new string[]{ "250", "Flags/belgium:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {34, new string[]{ "250", "Flags/bhutan:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {35, new string[]{ "250", "Flags/brazil:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {36, new string[]{ "250", "Flags/britain:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {37, new string[]{ "250", "Flags/canada:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {38, new string[]{ "250", "Flags/china:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {39, new string[]{ "250", "Flags/croatia:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {40, new string[]{ "250", "Flags/denmark:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {42, new string[]{ "250", "Flags/egypt:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {43, new string[]{ "250", "Flags/finland:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {44, new string[]{ "250", "Flags/france:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {45, new string[]{ "250", "Flags/germany:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {46, new string[]{ "250", "Flags/ghana:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {47, new string[]{ "250", "Flags/greece:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {48, new string[]{ "250", "Flags/india:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {49, new string[]{ "250", "Flags/indonesia:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {50, new string[]{ "250", "Flags/italy:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {51, new string[]{ "250", "Flags/japan:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {52, new string[]{ "250", "Flags/netherlands:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {53, new string[]{ "250", "Flags/norway:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {54, new string[]{ "250", "Flags/philippines:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {55, new string[]{ "250", "Flags/portugal:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {56, new string[]{ "250", "Flags/republicofpoland:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {57, new string[]{ "250", "Flags/russia:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {58, new string[]{ "250", "Flags/singapore:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {59, new string[]{ "250", "Flags/southafrica:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {60, new string[]{ "250", "Flags/southkorea:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {61, new string[]{ "250", "Flags/spain:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {62, new string[]{ "250", "Flags/sweden:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {63, new string[]{ "250", "Flags/switzerland:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {64, new string[]{ "250", "Flags/thailand:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {65, new string[]{ "250", "Flags/turkey:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {66, new string[]{ "250", "Flags/uganda:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
        {67, new string[]{ "250", "Flags/unitedarabemirates:24-48-72:#1B1B1B-#FF3333-#FFDB19" } },
